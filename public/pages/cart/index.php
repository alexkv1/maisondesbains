...
<main class="pagepad cartpage">
  ...
  <div class="cartpage__grid" id="cartPage" data-empty="The basket is empty.">
    ...
    <aside class="cartpage__summary" id="cartSummary">
      <div class="summary__row"><span>Subtotal</span><span class="mono" id="sumSubtotal"><?= money(0) ?></span></div>
      <div class="summary__row"><span>Delivery</span><span class="mono" id="sumShipping">—</span></div>
      <div class="summary__row summary__row--total"><span>Total</span><span class="mono" id="sumTotal"><?= money(0) ?></span></div>
      <p class="drawer__ship">Complimentary delivery over <?= freeShippingLabel() ?>. Taxes at checkout.</p>
