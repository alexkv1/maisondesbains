...
VALUES
  ('santal-33-shower-gel',    'Le Labo', 'Santal 33 Shower Gel',     'Shower Gel', 'Bath', 'Sandalwood · Cardamom · Iris · Leather', 'The cult Santal 33, drawn into a lathering shower gel. Smoky sandalwood and iris, left on warm skin.', NULL, NULL, UNIX_TIMESTAMP()),
  ...
  ('bal-dafrique-shower-gel', 'Byredo',  'Bal d''Afrique Shower Gel', 'Shower Gel', 'Bath', 'Bergamot · Neroli · Marigold · Vetiver', 'Byredo''s Bal d''Afrique as a shower gel — African marigold, neroli and warm vetiver.', '/assets/img/bal-dafrique-shower-gel.png', NULL, UNIX_TIMESTAMP()),
  ...
  ('bal-dafrique-soap',       'Byredo',  'Bal d''Afrique Soap',       'Soap', 'Bath', 'Bergamot · Neroli · Black Amber', 'A milled soap of Bal d''Afrique — bergamot and black amber, kept by the basin.', '/assets/img/bal-dafrique-soap.jpg', NULL, UNIX_TIMESTAMP()),
  ...
  ('bal-dafrique-candle',     'Byredo',  'Bal d''Afrique Candle',     'Scented Candle', 'Home', 'Bergamot · Cedarwood · Amber · Vetiver', 'The Bal d''Afrique reverie, in candlelight — bergamot and cedarwood over warm amber. Fills a room, quietly.', NULL, NULL, UNIX_TIMESTAMP())
...
FROM (
  ...
  SELECT 'bal-dafrique-candle',             'bal-dafrique-candle-240g',             '240 g',     4900, 529, 'MDB·BY—CAND', 40,  0, 1
) AS v
